...
def upgrade() -> None:
    ...
    op.add_column(
        "bookingcar",
        sa.Column("additional_services_airport", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "bookingcar",
        sa.Column("additional_services_railway_station", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "bookingcar",
        sa.Column("additional_services_your_address", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "bookingcar",
        sa.Column("additional_services_add_driver", sa.Boolean(), nullable=True),
    )
    op.add_column(
        "bookingcar",
        sa.Column("additional_services_washing", sa.Boolean(), nullable=True),
    )
